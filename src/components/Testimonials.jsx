...
export default function Testimonials() {
  return (
    <section className="py-24 bg-[#121118] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#8162BB]/20 border border-[#8162BB]/40 text-[#C4B8DC] text-xs font-semibold uppercase tracking-wider mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {REVIEWS_LIST.map((rev) => (
            <div
              key={rev.id}
              className="bg-[#1A1921] rounded-3xl p-8 border border-purple-900/30 shadow-2xl hover-lift flex flex-col justify-between"
            >
              <div>
                ...
                <div className="relative h-48 w-full rounded-2xl overflow-hidden mb-6">
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-black/70 backdrop-blur-md text-white text-xs font-medium px-3 py-1 rounded-full flex items-center gap-1">
                ...
                {/* Quote */}
                <p className="text-neutral-200 text-base font-light leading-relaxed mb-6 font-subserif italic">
                  "{rev.quote}"
                </p>
              </div>
