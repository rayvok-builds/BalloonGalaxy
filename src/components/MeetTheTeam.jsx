      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {TEAM_DATA.members.map((member, idx) => (
            <div
              key={idx}
              className="bg-[#FAF8F5] rounded-3xl p-8 border border-neutral-200/80 shadow-lg flex flex-col justify-between hover-lift relative overflow-hidden"
            >
              {/* Top Accent Gradient */}
              ...
              <div>
                ...
                <div className="flex items-start justify-between mb-6 pt-2">
                  ...
                  <div className="w-12 h-12 rounded-full bg-[#8162BB]/10 text-[#8162BB] flex items-center justify-center font-serif text-xl font-bold">
                    {member.name[0]}
                  </div>
                </div>

                {/* Bio */}
                <p className="text-neutral-700 text-sm font-light leading-relaxed mb-6">
                  {member.bio}
                </p>

                {/* Roles & Duties */}
                <div className="bg-white rounded-2xl p-5 border border-neutral-200/60 mb-6">
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-neutral-600 font-medium">
              ...
              {/* Quote */}
              <blockquote className="italic font-subserif text-base text-neutral-800 border-l-2 border-[#8162BB] pl-4 pt-2">
                "{member.quote}"
              </blockquote>
