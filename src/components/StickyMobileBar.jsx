...
export default function StickyMobileBar({ onOpenQuoteModal }) {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-[#0B0A0E]/95 backdrop-blur-lg border-t border-purple-900/30 px-3 py-2.5 shadow-2xl animate-in slide-in-from-bottom-2">
